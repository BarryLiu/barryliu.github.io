...
tags:
  ...
  - "入耳检测"
  - "按键灯效"
description: "开发板上按键（GPIO 0-8）--> Config Tool --> Easy_Pinmux 下GPIO (GPIO 与 VarName对应)\t--> KeysGPIO（之前的VarName与 各个key里面的varname对应）找到是key几就是key几 ---> 再到Key_Event里面找 "
featured: false
---
