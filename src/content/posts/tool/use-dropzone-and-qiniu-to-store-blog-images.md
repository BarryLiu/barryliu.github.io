...
date: 2015-01-10
postSlug: "tool/use-dropzone-and-qiniu-to-store-blog-images"
categories:
  - "工具"
tags:
  - Blog
description: "之前我在用SAE的Storage作为博客图床，但是令我非常不爽的是没有一个很好的上传和获得公共链接的方法。现在总算用Dropzone和七牛把这个问题解决了，下面是我上传图片和获得URL的操作，方法再往下看。"
