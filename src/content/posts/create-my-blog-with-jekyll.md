...
title: "Jekyll 搭建静态博客"
date: 2015-02-15
postSlug: create-my-blog-with-jekyll
categories:
  - jekyll
tags:
  - jekyll
  - RubyGems
description: "一直以来都想搭建一个自己的博客，但是近半年做项目太忙，所以也一直没顾得上。一次偶然在网上上看到一些博客相关的内容，参考node.js下的hexo和 ruby下的jekyll，两个都是用github pages功能的静态页面,一个是将遍以后的markdown文本转成html上传,一个是直接上传mark"
featured: false
---
