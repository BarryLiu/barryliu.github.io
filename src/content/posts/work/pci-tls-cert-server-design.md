...
title: "PCI认证服务端实现"
date: 2025-07-04
postSlug: "work/pci-tls-cert-server-design"
categories:
  - go
tags:
  - TLS
  ...
  - "双向认证"
  - Go
description: "TLS 1.2 和 TLS 1.3 是 **传输层安全协议（Transport Layer Security）** 的两个版本，用于在互联网通信中提供加密和身份验证功能。TLS 1.3 是 TLS 1.2 的升级版本，在安全性、性能和隐私方面都有显著改进。"
featured: false
---
...
![image-20250704173830108](/posts-assets/work/assets/image-20250704173830108.png)
#### 1.  无证书验证不通
> 浏览器直接获取,后台开启了验证证书,验证不通过无法直接获取文件
![image-20250704172842650](/posts-assets/work/assets/image-20250704172842650.png)
* ssh命令验证
  * 从下图使用openssl方式验证连接服务端连接并双向同步，tls1.2版本和tls1.3没有给到客户端证书都没有连接成功
  ![image-20250704174304213](/posts-assets/work/assets/image-20250704174304213.png)
  
#### 2. 有证书能验证通过
* ssh命令验证
  > 下图中指明客户端证书与ca文件，可以验证通过
  
  ![image-20250704180810756](/posts-assets/work/assets/image-20250704180810756.png)
