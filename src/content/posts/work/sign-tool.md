---
title: "Konnex Tool 签名工具客户端程序设计"
date: 2025-04-24
postSlug: "work/sign-tool"
categories:
  - python
tags:
  - python
  - PyQt6
  - "签名工具"
description: "[axure设计文档地址](https://gylx8v.axshare.com/?g=14&id=ecfafp&p=%E8%B4%A6%E5%8F%B7%E7%99%BB%E5%BD%95&sc=3)"
featured: false
---
...
- 打包工具：PyInstaller
## 2. 系统架构
![image-20250526144157548](/posts-assets/work/assets/image-20250526144157548.png)
以上是本程序到全局整体架构图
### 2.1 整体架构
...
![image-20250526150613542](/posts-assets/work/assets/image-20250526150613542.png)
![image-20250526150755466](/posts-assets/work/assets/image-20250526150755466.png)
### 3.2 业务逻辑处理
...
![image-20250416181125310](/posts-assets/work/assets/image-20250416181125310.png)
#### 5.1.2 连接 POS 机
...
![image-20250416183116936](/posts-assets/work/assets/image-20250416183116936.png)
#### 5.1.3 选择串口设备并导出证书
1. 在工作页面的 “串口设备选择” 区域，点击下拉菜单，从显示的串口设备列表中，精准选择与当前所连接 POS 机对应的指定串口设备。
1. 确认串口设备选择无误后，点击页面上的 “Receive Certificate” 按钮，证书导出流程正式启动。
![image-20250416183127904](/posts-assets/work/assets/image-20250416183127904.png)
#### 5.1.4 证书保存
...
![image-20250416183243610](/posts-assets/work/assets/image-20250416183243610.png)
### 5.2 APK 签名功能
#### 5.2.1 登录并进入签名页面
...
![image-20250416181603323](/posts-assets/work/assets/image-20250416181603323.png)
...
![image-20250416181713319](/posts-assets/work/assets/image-20250416181713319.png)
#### 5.2.4 签名结果保存
...
![image-20250416181744872](/posts-assets/work/assets/image-20250416181744872.png)
### 5.3 log功能
#### 5.3.1 **登录并进入日志页面**：
 打开应用程序，使用正确的账号和密码登录。登录成功后，在页面菜单栏中找到并点击 “Function” 选项。
![image-20250416182230549](/posts-assets/work/assets/image-20250416182230549.png)
#### 5.3.2 查看日志 
  在 “Function” 的下拉菜单中，点击 “Log” 选项，此时将跳转至日志页面，在此页面中可查看 APK 签名和证书导出操作所生成的日志记录。日志通常按照操作时间顺序进行排列，最新的操作记录显示在最上方。
![image-20250416182239809](/posts-assets/work/assets/image-20250416182239809.png)
## 6. 通信协议
