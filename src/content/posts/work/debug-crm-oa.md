...
tags:
  ...
  - "低代码"
  - CRM
description: "泛微OA是一种企业级办公自动化解决方案，旨在帮助组织提高工作效率、加强协作、优化业务流程。该系统通过集成各种功能和工具，提供了一套全面的办公自动化解决方案,，方便企业中更好的运行管理等操作， 但是公司不会只使用一套系统, 会有很多一些自主研发的系统需要接入泛微OA系统的情况, 下面记录一下开发调试泛"
featured: false
---
