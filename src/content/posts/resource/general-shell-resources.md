...
title: "Shell 常用资源"
date: 2014-01-15
postSlug: "resource/general-shell-resources"
categories:
  - "资源"
tags:
  - Shell
description: "grep aaa *"
keywords: Shell
featured: false
---
...
**一、linux上传文件命令：**
1.上传本地文件到linux，linux下载文件到本地命令
1)sz命令，发送/下载文件到**本地**：[ ]# sz filename
2)rz命令，本地上传文件到**服务器**：[ ]# rz
打开对应的Linux服务器目录，执行上述命令后，在弹出框中选择要上传的文件即可。
