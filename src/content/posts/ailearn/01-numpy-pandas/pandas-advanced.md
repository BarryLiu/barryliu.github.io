...
date: 2026-04-12
postSlug: "ailearn/01-numpy-pandas/pandas-advanced"
categories:
  - ailearn
tags:
  - AI
...
> **前置知识**：需要先掌握 [Pandas 基础教程](/posts/ailearn/01-numpy-pandas/pandas-basic/)。
>
...
| 字符串 | `str` 访问器, 正则表达式 |
---
**上一篇**：[Pandas 基础教程](/posts/ailearn/01-numpy-pandas/pandas-basic/)
**下一篇**：[Pandas 数据分析实战](/posts/ailearn/01-numpy-pandas/pandas-analysis/)
