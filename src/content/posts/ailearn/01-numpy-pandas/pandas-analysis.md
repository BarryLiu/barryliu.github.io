...
date: 2026-04-12
postSlug: "ailearn/01-numpy-pandas/pandas-analysis"
categories:
  - ailearn
tags:
  - AI
...
> **前置知识**：需要先掌握 [Pandas 进阶教程](/posts/ailearn/01-numpy-pandas/pandas-advanced/)。
>
...
---
**完整系列**：
1. [NumPy 基础教程](/posts/ailearn/01-numpy-pandas/numpy-basic/)
2. [NumPy 进阶教程](/posts/ailearn/01-numpy-pandas/numpy-advanced/)
3. [Pandas 基础教程](/posts/ailearn/01-numpy-pandas/pandas-basic/)
4. [Pandas 进阶教程](/posts/ailearn/01-numpy-pandas/pandas-advanced/)
5. **本文**：Pandas 数据分析实战
**返回**：[AI学习路线总览](/posts/ailearn/01-ai-foundation/)
*最后更新: 2026年4月12日*
> 参考资源：
