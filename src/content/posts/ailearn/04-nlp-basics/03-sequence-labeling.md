...
title: "序列标注实战 - NER与分词"
date: 2026-04-15
postSlug: "ailearn/04-nlp-basics/03-sequence-labeling"
categories:
  - ailearn
tags:
  - AI
...
> **前置知识**：需要先掌握 [文本分类](/posts/ailearn/04-nlp-basics/02-text-classification/)
>
> **本文重点**：序列标注模型与NER实战
---
## 一、序列标注概述
...
---
**上一篇**：[文本分类](/posts/ailearn/04-nlp-basics/02-text-classification/)
