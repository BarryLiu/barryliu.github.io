...
---
layout: post
title: Windows下MySQL定时备份任务配置
category: 技术
tags: [MySQL, Windows, 备份]
keywords: MySQL, 定时备份, Windows, 任务计划
description: 介绍Windows系统下如何创建MySQL定时备份任务，使用bat脚本实现自动化备份
---
...
![在这里插入图片描述](/posts-assets/skill/assets/ddbd0fe815e542ed87da1786b1420c4a.png)

2. 填写触发器，设定执行时间：

![在这里插入图片描述](/posts-assets/skill/assets/4bb2559f68ce40bcb2ad525b1812fb63.png)

3. 添加执行脚本文件
将刚才创建好的bat文件选中。

![在这里插入图片描述](/posts-assets/skill/assets/d73d9cea6627448cb544cc9c8973fc79.png)
