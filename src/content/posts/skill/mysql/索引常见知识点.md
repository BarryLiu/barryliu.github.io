...
title: "索引分类"
date: 2023-07-05
postSlug: "skill/mysql/索引常见知识点"
categories:
  - skill
tags: []
description: "今天来盘点一下关于MySQL索引常见的知识点"
featured: false
---
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906694-43.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906694-44.png)

对name字段建立Hash索引，但是通过`show index from 表名`就会发现实际还是B+树

![图片](/posts-assets/skill/mysql/assets/640-1688556906694-45.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906694-46.png)

Hash索引会对索引列name的值进行Hash计算，然后找到对应的槽下面，如下图所示

![图片](/posts-assets/skill/mysql/assets/640-1688556906694-47.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906694-48.png)

当数据不断地插入数据页中，数据会根据主键（没有的话会自动生成）的大小进行排序，形成一个单向链表

![图片](/posts-assets/skill/mysql/assets/640-1688556906694-49.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906694-50.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906695-51.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906695-52.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906695-53.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906695-54.png)

对于单个索引列数据查找也是跟前面说的聚簇索引一样，也会对数据分组，之后可以根据二分查找在单个索引列来查找数据。

当数据不断增多，一个索引页存储不下数据的时候，也会用多个索引页来存储，并且索引页直接也会形成双向链表

![图片](/posts-assets/skill/mysql/assets/640-1688556906695-55.png)

当索引页不断增多是，为了方便在不同索引页中查找数据，也就会抽取一个索引页，除了存页中id，同时也会存储这个id对应的索引列的值

![图片](/posts-assets/skill/mysql/assets/640-1688556906696-56.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906696-57.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906696-58.png)
...
![图片](/posts-assets/skill/mysql/assets/640-1688556906696-59.png)
